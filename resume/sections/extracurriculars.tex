...
\cvitem{2025}{NewHacks - Built app using React Native, OpenCV, Flask, Gemini, and Supabase that scans and digitizes receipts.}
\cvitem{2025}{UTMIST AI Squared Tournament (ongoing) - Built and trained reinforcement model to compete in a game.}
