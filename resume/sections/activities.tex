...
\cvitem{NewHacks 2025}{Built React Native + Flask + Gemini finances app. Digitizes and analyzes receipts.}
\cvitem{AI Squared Tournament 2025}{Implemented PPO-based PyTorch RL model achieving top 8 performance.}
...
\subsection{Music}
\cvitem{}{Trumpeter -- Vancouver Youth Jazz Orchestra, NWSS Jazz Bands, NWSS Pit Orchestra}
